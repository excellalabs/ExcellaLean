...
(function ($, window) {
    ...
    // creation/management of `Sammy.app` instances. There are a
    // number of different forms for `Sammy()` but each returns an instance
    // of `Sammy.app`. When a new instance is created using
    // `Sammy` it is added to an Object called `Sammy.apps`. This
    // provides for an easy way to get at existing Sammy apps. Only one
    // instance is allowed per `element_selector` so when calling
    // `Sammy('selector')` multiple times, the first time will create
    // the app and the following times will extend the app
    ...
    //      Sammy('#main')
    //
    //      // equivilent to "new Sammy.app", except appends to apps
    //      Sammy();
    //      Sammy(function() { ... });
    //
    ...
    Sammy = function () {
        ...
        if (args.length === 0 || args[0] && _isFunction(args[0])) { // Sammy()
            ...
            app = Sammy.apps[selector] || new Sammy.app();
    ...
    // The HashLocationProxy is the default location proxy for all Sammy apps.
    // A location proxy is a prototype that conforms to a simple interface. The purpose
    // of a location proxy is to notify the Sammy.app its bound to when the location
    ...
    // to this event and delegates it to the app. In the case of older browsers
    ...
    // Sammy.app is the Base prototype for defining 'apps'.
    // An 'app' is a collection of 'routes' and bound events that is
    // attached to an element when `run()` is called.
    // The only argument an 'app_function' is evaluated within the context of the app.
    Sammy.app = function (app_function) {
        var app = this;
        this.routes = {};
    ...
    Sammy.app.prototype = $.extend({}, Sammy.Object.prototype, {

        // the four route verbs
        ROUTE_VERBS: ['get', 'post', 'put', 'delete'],

        // An array of the default events triggered by the
        // app during its lifecycle
        ...
        // Defines what element the app is bound to. Provide a selector
        ...
        // //=> Sammy.app: body
        toString: function () {
            return 'Sammy.app:' + this.element_selector;
        },

        // returns a jQuery object of the apps bound element.
        ...
        // in the context of the current app, just like the `app_function`
        // argument to the `Sammy.app` constructor.
        //
        ...
        // `route()` is the main method for defining routes within an app.
        ...
        // A unique event namespace defined per app.
        ...
        //
        // * It binds all events to the app element
        // * All events are bound within the `eventNamespace()`
        // * Events are not actually bound until the app is started with `run()`
        ...
        // Adds an around filter to the app. around filters are functions
        ...
        // Returns `true` if the current app is running.
        isRunning: function () {
        ...
        // Actually starts the app's lifecycle. `run()` should be invoked
        // within a document.ready block to ensure the DOM exists before binding events, etc.
        //
        // ### Example
        //
        //     var app = $.sammy(function() { ... }); // your app
    ...
    //
    //       $.sammy(function() {
    //         // The context here is this Sammy.app
    ...
    // ### Arguments
    //
    // * `app` The `Sammy.app` this event is called within.
